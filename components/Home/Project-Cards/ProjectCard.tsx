...
export const ProjectCard = ({ project, baseImagePath }: ProjectCardProps) => {
  ...
  return (
    <div className="flex flex-col gap-2 bg-stone-300 dark:bg-stone-900 rounded-lg overflow-hidden">
      <img src={getImagePath()} />
      <div className="px-2 flex flex-col md:flex-row justify-end md:items-end md:justify-between">
        <h1 className="font-nunito text-2xl">{project.name.toLowerCase()}</h1>
